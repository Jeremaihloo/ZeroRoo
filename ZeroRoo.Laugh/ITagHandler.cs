...
namespace ZeroRoo.Laughing
{
    ...
    public interface ITagHandler
    {
        ...
        /// </param>
        void TagBeginProcess(LaughingManager manager, Tag tag, ref bool processInnerElements, ref bool captureInnerContent);
        ...
        /// </param>
        void TagEndProcess(LaughingManager manager, Tag tag, string innerContent);
    }
}
