...
namespace ZeroRoo.Utils
{
    ...
    public class PinYinBuilder
    {
        ...
        /// <param name="ch"></param>        
        /// <returns></returns>        
         public String GetHanz2PinYinFirst(Char ch)
         {
             var rs = Hanz2PinYin(ch);  
        ...
        /// <returns></returns>
         public String GetHanz2PinYinFirst(String str)
         {
             ...
             { 
                 sb.Append(GetHanz2PinYinFirst(chs[i]));
             } 
        ...
        /// <param name="ch"></param>
        /// <returns></returns>
         public String Hanz2PinYin(Char ch)
         {
             // 拉丁字符            
        ...
        /// </summary>
         ...
         public String Hanz2PinYin(String str)
         {
             if (String.IsNullOrEmpty(str)) return String.Empty; 
