...
<template>
  <div class="wallpaper-section">
    <div class="wallpaper-section" @click="emit('click:wallpaper',$event)" @drop="drop($event)" @dragover="dragover($event)" @mousedown="mousedown($event)" @mouseup="emit('mouseup:wallpaper',$event);">
    </div>
    <a href="https://github.com/chairuosen/desktop-simulation">
